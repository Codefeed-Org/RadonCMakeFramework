	...
	if(MSVC)
		...
		if ("${CMAKE_GENERATOR}" MATCHES "Visual Studio")
		  foreach (config ${CMAKE_CONFIGURATION_TYPES})
            ...
            set_target_properties(${${projectid}_NAME} PROPERTIES LIBRARY_OUTPUT_DIRECTORY_${config_upper} "${CMAKE_LIBRARY_OUTPUT_DIRECTORY}" )          
            set_target_properties(${${projectid}_NAME} PROPERTIES RUNTIME_OUTPUT_DIRECTORY_${config_upper} "${CMAKE_RUNTIME_OUTPUT_DIRECTORY}" )          
            set_target_properties(${${projectid}_NAME} PROPERTIES ARCHIVE_OUTPUT_DIRECTORY_${config_upper} "${CMAKE_ARCHIVE_OUTPUT_DIRECTORY}" )                 
		  endforeach ()
		endif ()	
	endif()
endmacro()
